  ...
  return (
    <div className="info">
      <div className="info-text">
        ...
        <p>Any profile photos that you upload are saved until you delete your account.</p>
        ...
        <p>The application stores an access token that is created when you log in. It is there to ensure that it's you who wants to view your previously logged moods or asking for an intention before your meditation. The token is removed when you logout or after it expires which causes you to reauthenticate.</p>
        <h3>Can I remove my data?</h3>
        <p>On your profile page under "Practice" - "My practice", you will find a link you can use if you would like to delete your account. This will also delete all your previously logged moods and your profile photo.</p>
        <h3>Contact</h3>
